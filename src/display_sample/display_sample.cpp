...
// Module    : ER-TFTM043-3  4.3 INCH TFT LCD  480*272
// Lanuage   : C51 Code
// Create    : JAVEN LIU
// Date      : Aug-23-2013
// Drive IC  : RA8875    Font chip  23L32S4W    Flash:16-128M bit
// INTERFACE : 4-wire SPI
// MCU 		 : STC12LE5C60S2  //51 series MCU
// MCU VDD		 : 3.3V   
//----------------------------------------------------------------------
...
void main(void)
{
  ...
  while (1)
  {
    ...
    FontWrite_Position(0, 165);//Text written to the position
    String("ER-TFTM043-3，Optional Chinese / English character library,  MicroSD cord,Falsh.Font Support 2/3/4 times magnification."
    ...
    FontWrite_Position(70, 10);//Text written to the position
    ...
    Write_Dir(0X8E, 0X80);//Began to clear the screen (display window)
    Chk_Busy();
    Active_Window(40, 150, 100, 200);//Set the work window size
    ...
    Active_Window(150, 479, 180, 271);//Set the work window size
    ...
    Delay10ms(5);
    /////////////drawing rectangle
    Draw_Line(10, 110, 136, 262);
    Text_Foreground_Color1(color_brown);//Color Settings
    ...
    Delay10ms(5);
    ///////////drawing triangle
    Draw_Line(260, 365, 262, 136);
    Draw_Triangle(470, 262);//draw a triangle of three point
    ...
    Draw_Line(130, 240, 136, 262);
    Draw_Ellipse(0, 0, 10, 15);//Set Radius
    ...
    Delay10ms(2);
    Draw_Line(479, 479, 0, 271);//drawing line
    Write_Dir(0X90, 0X80);//Start drawing
    Delay10ms(2);
    Draw_Line(0, 479, 271, 271);//drawing line
    Write_Dir(0X90, 0X80);//Start drawing
    Delay10ms(2);
    Draw_Line(0, 0, 0, 271);//drawing line
    Write_Dir(0X90, 0X80);//Start drawing
    Delay10ms(2);
    NextStep();
    ...
    Active_Window(0, 479, 0, 271);//Set the working window size
    Text_Foreground_Color1(color_white);//Set the foreground color
...
unsigned char code Pic1[1500] = { /* 0X00,0X01,0X78,0X00,0X64,0X00, */
